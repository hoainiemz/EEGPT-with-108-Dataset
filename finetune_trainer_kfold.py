...
class Trainer(object):
    ...
    def train_for_binaryclass(self):
        ...
        for epoch in range(self.params.epochs):
            ...
            with torch.no_grad():
                # acc, pr_auc, roc_auc, cm = self.train_eval.get_metrics_for_binaryclass(self.model)
                # wandb.log({
                #     "epoch": epoch + 1,
                ...
                # print(cm)
                val_acc, val_pr_auc, val_roc_auc, val_cm = self.val_eval.get_metrics_for_binaryclass(self.model)
                print(
                ...
                if val_roc_auc > roc_auc_best:
                    ...
                    acc_best = val_acc
                    pr_auc_best = val_pr_auc
                    roc_auc_best = val_roc_auc
                    cm_best = val_cm
        ...
        with torch.no_grad():
            ...
            model_path = self.params.model_dir + "/epoch{}_acc_{:.5f}_pr_{:.5f}_roc_{:.5f}.pth".format(self.params.epochs, acc, pr_auc, roc_auc)
